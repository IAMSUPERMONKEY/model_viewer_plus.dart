...
class ModelViewerState extends State<ModelViewer> {
  ...
  void _init() async {
    ...
    widget.javascriptChannels?.forEach((element) {
      _webViewController.addJavaScriptChannel(element.name, onMessageReceived: element.onMessageReceived);
    });
    _webViewController.loadRequest(Uri.parse(_proxyURL)).then((value) {
      widget.onWebViewCreated?.call(_webViewController);
    });
  }
